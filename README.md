...
> `R_×≈2038`** (Barkley's 2040). The test suite (112 tests) runs in CI — including
> method-of-manufactured-solutions **code verification** and a citation-tagged
> **reference registry** (scalars *and* digitized-figure curves) that fails the
> build on any unsourced number (see [`VALIDATION.md`](VALIDATION.md)). See
